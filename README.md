# The result of our work (skiessli, cpoirier, awoimbee) on corewar

- To test the project (macOS & linux):
	```sh
	make
	./asm our_champ.s
	./disassembler our_champ.s # you don't need to launch this, but we wrote it

	# /!\ now is a good time to make your terminal window big enough
	./corewar ./our_champ.cor ./our_champ.cor ./our_champ.cor -vi -rand
	```
...
Note the absence of a `.gitignore` among other things.  
This is because this project is to 42's norme.  
This git does not differ in any way (appart from this README) to what was validated at 42.

# A very good description of the subject from [cepalle](https://github.com/cepalle/corewar):
